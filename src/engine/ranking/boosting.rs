...
use crate::engine::tokens::split_identifier;
...
pub fn boost_multi_chunk_files(scores: &mut HashMap<usize, f64>, chunks: &[Chunk]) {
    ...
    for (&idx, &score) in scores.iter() {
        ...
        *file_sum.entry(fp).or_default() += score;
        // map_or rather than is_none_or, which is stable since 1.82 and this
        // workspace promises 1.78. Same meaning: absent counts as best.
